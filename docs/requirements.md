...
- REQ-051: WHEN the DiaryKeeper branch is rendered THE SYSTEM SHALL use the supplied journal-and-quill artwork as the Dear Diary advancement icon through the Minecraft 1.21.4+ item model `enthusia:journal_quill`.
